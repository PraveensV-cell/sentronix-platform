...
SOURCE_IMAGES = Path("datasets/raw/safety/images")


SOURCE_ANNOTATIONS = Path("datasets/raw/safety/annotations")
...
def main() -> None:
    ...
    print("Safety YOLO Conversion Started")

    create_directories()

    convert_dataset()

    print("Safety conversion completed")
