...
SOURCE_IMAGES = Path("datasets/raw/weapon/images")


SOURCE_ANNOTATIONS = Path("datasets/raw/weapon/annotations")
...
def main() -> None:
    ...
    print("Weapon YOLO Conversion Started")
